...
| 4 |🚧 [Storytelling with Data](https://public.tableau.com/views/Book1WIP1_3/Dashboard1?:language=en-US&:sid=&:display_count=n&:origin=viz_share_link) 🚧| The project task was find the cause of returned order at 'Superstore' using Tableau storytelling. 🚧 CURRENTLY A WIP 🚧|
| 5 |🚧 [Customer Analysis Segmentation](https://public.tableau.com/app/profile/lee.redfearn/viz/TTFinalProject1_2WIP/CustomerAnalysis) 🚧| The project task was find the cause of returned order at 'Superstore' using Tableau storytelling. 🚧 CURRENTLY A WIP 🚧|
